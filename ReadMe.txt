--------------------------------------------
DDC Ocr Restful Api Sample - java ReadMe
--------------------------------------------
...
1. Load the sample into Eclipse.
2. Update "strApiKey" in Configuration.java with your own secret key. For details on how to get a secret key, please check
   https://developer.dynamsoft.com/authenticating-to-the-cloud-api
3. Run the sample in Eclipse.
